...
export default function ContactSection() {
  ...
  const handleEmailClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    // Try mailto first
    const mailtoLink = "mailto:bueno.rjadev@gmail.com";
    window.location.href = mailtoLink;

    // Fallback: copy email to clipboard after a short delay
    setTimeout(() => {
      navigator.clipboard
        .writeText("bueno.rjadev@gmail.com")
        .then(() => {
          setShowCopied(true);
        ...
        .catch(() => {
          ...
          textArea.value = "bueno.rjadev@gmail.com";
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col items-center gap-6 mb-8">
              <div className="relative">
                ...
                {showCopied && (
                  <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-1 bg-green-600 text-white text-sm rounded-lg shadow-lg animate-pulse whitespace-nowrap">
                    Email copied to clipboard!
                  </div>
                )}
              </div>
              <motion.a
                href="/RoniJemBueno-resume.pdf"
                target="_blank"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              <div className="flex gap-4">
                ...
                <motion.a
                  href="https://www.linkedin.com/in/roni-bueno-979705309/"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="group flex items-center justify-center p-4 bg-purple-50 hover:bg-purple-100 rounded-xl border border-purple-200 transition-all duration-300"
                >
